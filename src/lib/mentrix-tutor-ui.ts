...
export const mentrixTutor = {
  ...
  heroGradient:
    "relative overflow-hidden rounded-3xl bg-[linear-gradient(160deg,#1e3a8a_0%,#2563eb_45%,#3b82f6_100%)] text-white shadow-[0_20px_44px_-26px_rgba(30,58,138,0.55)] before:pointer-events-none before:absolute before:inset-0 before:bg-[url('/mentrixalogo/logo.png')] before:bg-[length:118px_118px] before:bg-repeat before:opacity-[0.065] before:content-['']",
