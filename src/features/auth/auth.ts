...
import {
  OAUTH_INTENT_COOKIE,
  OAUTH_ROLE_COOKIE,
} from "@/shared/integrations/oauth-auth";
import {
  validateEmail,
  validatePassword,
  validateRole,
...
import { createVerificationForUser } from "@/features/verification/verification-queue";
import { trackEvent } from "@/shared/integrations/analytics";
import { tryAutoAssociateInstitution } from "@/features/institutions/institution";
import { signUpServerSchema } from "@/shared/core/schemas";
...
} from "@/features/registration/registration-request-join";
