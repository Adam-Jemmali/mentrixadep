...
import { streamStudioSessionPackageText } from "@/shared/integrations/ai";
import { parseStudioPackageFromModelText } from "@/features/studio-ai/studio-package-lib";
import { toUserFacingAiError } from "@/shared/core/user-facing-error";
import { buildSessionPackageRichContext, persistStudioDraftFromNormalized } from "@/features/studio-ai/studio-packages";
