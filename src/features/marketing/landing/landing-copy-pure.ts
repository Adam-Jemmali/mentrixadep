 ...
 * - Mentrixer: locked first answers → live feed + Mentrixer rank + passport.
...
export const LANDING_ROLES = {
  ...
  mentrixer: {
    ...
    proof: "Mentrixer rank from your first answers.",
  ...
  guide: {
    ...
    proof: "Guide Impact Score from better first answers.",
...
export const LANDING_HERO = {
  ...
  arenaLine: "Watch it happening right now:",

  arenaLink: "Live Arena",
...
export const LANDING_SOCIAL = {
  ...
  sentence: "Mentrixer names on the feed. First answers only. Calculus AB live.",
...
export const LANDING_STORY_BRIDGES = [

  {
    ...
    subtitle: "Quest. Duel. Live feed. Your first answer locks.",
...
export const LANDING_OUTCOMES = {
  ...
  items: [
    ...
    { word: "Quest", sentence: "Locked first answers from the item bank." },
...
export const LANDING_WHY = {
  ...
  with: [
    ...
    "One first answer per skill. Locked.",

    "Calculus AB live now. Every skill same bar.",

    "Public feed. Practice never moves it.",
  ...
  sides: [

    {
      ...
      points: [
        ...
        "Quest. Duel. Live feed. First answers only.",
...
export const LANDING_GUIDE_LADDER = {
  ...
  sentence: "Practitioner to Elite. Better first answers after your sessions.",
...
export const LANDING_GUIDE = {
  ...
  subtitle: "Live teachers on Mentrixa. Impact Score proof.",
  ...
  features: [
    ...
    { word: "Studio", sentence: "Transcript of live call becomes a Quest pack. You approve before send." },
...

    {
      ...
      items: [

        {
          ...
          body: "Your first answers on live skill nodes. Calculus AB today.",

          verdict: "Practice after your first answer never rewrites it.",
...

        {
          ...
          body: "After five nodes have a locked first answer.",
...

        {
          ...
          body: "Yes. You learn. Your first answer stays frozen.",
...

    {
      ...
      items: [

        {
          ...
          body: "Better first answers on skills you taught live.",
...

    {
      ...
      items: [

        {
          ...
          nextAction: "Sign up. Lock your first answer.",
...

        {
          ...
          body: "Any skill can join later. Each needs a reviewed bank and enough first answers.",
