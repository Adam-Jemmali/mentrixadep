...
export const landingHub = {
  ...
  eyebrow: "lp-body mx-hub-type-ui text-[#6366F1]",
  title: "lp-hand-title text-[clamp(1.35rem,3.4vw,2.25rem)] font-bold leading-tight text-[#0B1220]",
  titleHero:
    "lp-hand-title lp-hero-headline text-pretty font-bold italic tracking-[-0.02em] text-[#0B1220] leading-[1.1]",
  stickyWord: "lp-sticky-word",
  body: "lp-body text-base leading-relaxed text-[#334155]",
  bodySm: "lp-body text-sm leading-relaxed text-[#475569]",
  inkMuted: "lp-body text-[#475569]",
  ...
  hint: "lp-body text-[11px] font-medium text-[#475569]",
  linkBack: "lp-body text-sm font-semibold text-[#4F46E5] hover:text-[#0B1220]",
} as const;
