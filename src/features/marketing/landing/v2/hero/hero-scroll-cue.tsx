...
export function HeroScrollCue() {
  ...
  return (
    <motion.a
      href="#outcomes"
      className={`absolute bottom-6 left-1/2 z-20 flex -translate-x-1/2 flex-col items-center gap-1 text-[10px] font-semibold uppercase tracking-[0.2em] ${landingHub.hint} transition-colors hover:text-[#0B1220]`}
      animate={{ y: [0, 6, 0] }}
