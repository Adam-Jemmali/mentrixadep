...
import { ACCOUNT_RANK_VISUALS, normalizeRankTitle } from "@/lib/rank-icons";
import { RankBadge, RankTitle } from "@/components/student/rank-badge";
import { ArenaMeshBackground } from "@/components/landing/v2/backgrounds/arena-mesh-background";
import { fadeUp, staggerContainer, viewportOnce, springSoft } from "@/components/landing/v2/motion/landing-motion";
