...
import { type SliceRole } from "@/components/landing/v2/motion/falling-role-slice-arena";
import { easeOutExpo, springSoft } from "@/components/landing/v2/motion/landing-motion";
import { useLandingMotion } from "@/components/landing/v2/motion/use-landing-motion";
import { HeroWaitlistNinjaStage } from "@/components/landing/v2/hero/hero-waitlist-ninja-stage";
import { HeroWaitlistSliceBurst } from "@/components/landing/v2/hero/hero-waitlist-slice-burst";
import { HeroWaitlistFormPop } from "@/components/landing/v2/hero/hero-waitlist-form-pop";
import type { CoachRevealData } from "@/components/landing/v2/hero/hero-waitlist-coach-reveal";
