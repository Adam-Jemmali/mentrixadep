...
export function DuelInviteeActions({ duelId }: { duelId: string }) {
  ...
  return (
    <div className="rounded-lg border border-violet-200 bg-violet-50/80 px-4 py-3 space-y-3">
      <p className="text-sm text-violet-900 font-medium">You were challenged to a skill duel</p>
